...
|------|-------------|--------------|------------|
| `47_JS.js` | Browser | Built-in `prompt()` | Run from a browser page or console |
| `48_Node_UI.js` | Node.js | Built-in `readline` module | `node 08_UserInputs/49_Node_UI.js` |
| `49_Prompt.js` | Node.js | `prompt-sync` package | Install `prompt-sync`, then run the file |
| `50_Fs.js` | Node.js | `fs.readFileSync(0, "utf8")` | `node 08_UserInputs/51_Fs.js` |
