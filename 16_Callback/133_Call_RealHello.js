...
// to overdue the callback hell, we can use promises and async/await to make the code more readable and maintainable. Here's an example of how you can refactor the above code using promises: